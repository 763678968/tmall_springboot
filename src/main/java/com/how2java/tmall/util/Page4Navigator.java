...
public class Page4Navigator<T> {
    ...
    // 分页的时候，如果总页数比较多，那么显示出来的分页超链一共有几个。
    // 比如，如果分页出来的超链是这样的：[8,9,10,11,12]，那么navigatePages就是5。
    int navigatePages;
    ...
    // 分页的时候，如果总页数比较多，那么显示出来的分页超链一共有几个。
    // 比如如果分页出来的超链是这样的：[8,9,10,11,12]，那么navigatepageNums就是这个数组：
    // [8,9,10,11,12]，这样便于前端展示。
